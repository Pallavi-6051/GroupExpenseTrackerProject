...
public class Calculate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        div_amt=findViewById(R.id.div_amt);
        calculateList=findViewById(R.id.calculateList);

        cursor.moveToLast();
        String memberCount=cursor.getString(0);
        ...
        int eachToPay=totalSum/Integer.parseInt(memberCount);
        div_amt.setText("Divided Amount: Rs. "+eachToPay);
        cursor = myDatabase.getAllData();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                Cursor innerCursor = myDatabase.getExpenseById(memId);
                int amtPaid = 0;
...
//            System.out.println(dataList.get(0));
            ...
            int k=0;
            for(int j=0;j<Integer.parseInt(memberCount);j++){
            ...
            for(int j=0;j<Integer.parseInt(memberCount);j++){
                ExpandingItem item = calculateList.createNewItem(R.layout.expanding_layout_calculate);
